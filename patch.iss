...
Name: "Modpack"; Description: "Sideloader Modpack 19-10-2018 (Lots of additional content, needed to properly load most character cards and scenes)"; Types: full extra
...
Name: "FIX\FixCompilation"; Description: "FixCompilation v1.1.0 (Improves performance)"; Types: full extra
Name: "FIX\FixShaderDropdown"; Description: "FixShaderDropdown v1.0 (Expands shader menu)"; Types: full extra 
Name: "FIX\DefaultParamEditor"; Description: "DefaultParamEditor v1.1.0 (Set custom default studio settings) + Improved setting set"; Types: full extra 
...
Name: "MISC\Trainer"; Description: "Cheat tools v1.8 (Trainer and debugger)"; Types: extra
Name: "MISC\FullSave"; Description: "100% Save";
Name: "MISC\UnlockHPositions"; Description: "UnlockHPositions v1.1.0 (Unlocks all positions)";      
...
;-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Source: "Input\koikatu_02plus_cdp08mp31v2_all\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs; Components: Patch
...
begin
  ...
  begin       
    ...
    else if (FileExists(ExpandConstant('{app}\manifest.xml'))) then
